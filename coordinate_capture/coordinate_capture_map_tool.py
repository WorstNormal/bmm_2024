...
class CoordinateCaptureMapTool(QgsMapToolEmitPoint):
    ...
    def canvasPressEvent(self, e):
        if e.button() == Qt.LeftButton:
            ...
            s = 3
            point1 = QgsPointXY(self.mapCanvas.getCoordinateTransform().toMapCoordinates(e.x() - s, e.y() - s))
            point2 = QgsPointXY(self.mapCanvas.getCoordinateTransform().toMapCoordinates(e.x() + s, e.y() - s))
            point3 = QgsPointXY(self.mapCanvas.getCoordinateTransform().toMapCoordinates(e.x() + s, e.y() + s))
            point4 = QgsPointXY(self.mapCanvas.getCoordinateTransform().toMapCoordinates(e.x() - s, e.y() + s))
